...
export const PortfolioDashboard: React.FC<PortfolioDashboardProps> = ({
  ...
  return (
    <div className="flex flex-col gap-8 w-full font-sans text-[#172033] pb-16">
      ...
      <section className="bg-gradient-to-br from-[#0B1F33] to-[#2563EB] text-white rounded-[24px] p-5 sm:p-6 shadow-xl relative overflow-hidden space-y-4">
      ...
      {activeTab === 'overview' && (
        <div className="space-y-8 animate-in fade-in duration-300">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch">
            ...
            <div className="lg:col-span-2 bg-white rounded-[28px] border border-[#E2E8F0] p-6 shadow-sm space-y-4">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-4 text-xs font-bold">
                  <div className="flex items-center gap-1.5"><span className="w-3 h-3 rounded-full bg-[#2563EB]" /> Your Lab (+12.28%)</div>
              ...
              <div className="h-64 w-full">
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={[
                    ...
                    <Tooltip />
                    <Area type="monotone" dataKey="lab" stroke="#2563EB" strokeWidth={3} fillOpacity={1} fill="url(#labColor)" />
            ...
            <div className="bg-[#0B1F33] text-white rounded-[28px] p-6 shadow-lg flex flex-col justify-between space-y-6">
              ...
              <div className="pt-4 border-t border-white/15 space-y-3">
                ...
                <button
                  ...
                  className="w-full py-3 bg-white text-[#0B1F33] font-black text-xs rounded-xl shadow-md transition cursor-pointer flex items-center justify-center gap-2"
                >
          ...
          <div className="bg-white rounded-[28px] border border-[#E2E8F0] p-6 space-y-4">
            <div className="flex items-center justify-between">
              ...
              <button onClick={() => setActiveTab('holdings')} className="text-xs font-extrabold text-[#2563EB] hover:underline cursor-pointer">
                View All Holdings →
              </button>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              {holdings.map(h => (
                <div
                  ...
                  className="p-5 rounded-2xl border border-[#E2E8F0] bg-[#F8FAFC] hover:bg-blue-50/40 hover:border-[#2563EB] transition cursor-pointer space-y-3 group"
                >
                  <div className="flex justify-between items-start">
                    <div>
                      <span className="font-black text-base text-[#172033] group-hover:text-[#2563EB] transition-colors">{h.symbol}</span>
                  ...
                  <div className="flex justify-between items-baseline pt-2 border-t border-[#E2E8F0]">
                    ...
                    <div className="text-right space-y-0.5">
                      ...
                      <div className="font-black text-sm text-[#2563EB]">₹{h.currentValueTokens.toLocaleString('en-IN')}</div>
                    </div>
                  </div>
                </div>
              ))}
      ...
      {activeTab === 'holdings' && (
        <div className="space-y-6 animate-in fade-in duration-300">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={() => setIsInvestModalOpen(true)}
              className="px-5 py-2.5 bg-[#2563EB] text-white font-extrabold text-xs rounded-xl shadow-md hover:bg-[#0B1F33] transition cursor-pointer"
            >
              + Invest Tokens
            </button>
          </div>
          ...
          <div className="space-y-4">
            {holdings.map(h => (
              <div
                key={h.symbol}
                onClick={() => setSelectedHoldingForDetail(h)}
                className="bg-white rounded-[24px] border border-[#E2E8F0] hover:border-[#2563EB] transition-all p-6 shadow-sm space-y-4 cursor-pointer group"
              >
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-[#E2E8F0] pb-4">
                  <div className="space-y-1">
                    <div className="flex items-center gap-2">
                      <span className="font-black text-xl text-[#172033] group-hover:text-[#2563EB] transition-colors">{h.symbol}</span>
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <div className="text-right">
                      ...
                      <span className="font-black text-lg text-[#2563EB]">₹{h.currentValueTokens.toLocaleString('en-IN')}</span>
                    </div>
                ...
                <div className="bg-[#F8FAFC] p-4 rounded-2xl border border-[#E2E8F0] flex items-start justify-between gap-4">
                  <div className="space-y-1">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs font-bold text-[#2563EB]">{h.thesisState}</span>
                    </div>
      ...
      {activeTab === 'performance' && (
        <div className="space-y-8 animate-in fade-in duration-300">
          ...
          <div className="bg-white rounded-[28px] border border-[#E2E8F0] p-6 sm:p-8 space-y-6 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 bg-[#F8FAFC] p-6 rounded-2xl border border-[#E2E8F0]">
              <div className="space-y-1">
                ...
                <div className="text-3xl font-black text-[#2563EB]">+12.28%</div>
              ...
              {holdings.map(h => (
                ...
                >
                  ...
                  <div className="text-xs text-[#64748B] space-y-1 font-medium">
                    ...
                    <div>Thesis: <strong className="text-[#2563EB]">{h.thesisState}</strong></div>
                  </div>

                  <button className="text-[11px] font-extrabold text-[#2563EB] hover:underline block pt-2 border-t border-[#E2E8F0] w-full text-left">
          ...
          <div className="bg-[#0B1F33] text-white rounded-[28px] p-6 sm:p-8 space-y-6 shadow-xl">
            <div className="space-y-1">
              ...
              <table className="w-full text-left text-xs font-medium">
                ...
                <tbody className="divide-y divide-[#E2E8F0]">
                  <tr className="hover:bg-[#F8FAFC]">
                    ...
                    <td className="py-3 px-4 font-bold text-[#2563EB]">78/100</td>
                  ...
                  <tr className="hover:bg-[#F8FAFC]">
                    ...
                    <td className="py-3 px-4 font-bold text-[#2563EB]">81/100</td>
                  ...
                  <tr className="hover:bg-[#F8FAFC]">
                    ...
                    <td className="py-3 px-4 font-bold text-[#2563EB]">74/100</td>
      ...
      {activeTab === 'insights' && (
        <div className="space-y-8 animate-in fade-in duration-300">
          ...
          <div className="bg-white rounded-[28px] border border-[#E2E8F0] p-6 sm:p-8 space-y-6 shadow-sm">
            <div className="space-y-1">
              <span className="text-xs font-bold text-[#2563EB] uppercase">Alternative Scenario Testing</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="p-5 rounded-2xl border border-[#E2E8F0] bg-[#F8FAFC] space-y-3">
                ...
                <div className="text-xs font-bold text-[#2563EB]">Your Lab Outperformed by +₹5,805</div>
              </div>
              ...
              <div className="p-5 rounded-2xl border border-[#E2E8F0] bg-[#F8FAFC] space-y-3">
                ...
                <div className="text-xs font-bold text-[#2563EB]">Current allocation offered better risk balance</div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            {holdings.map(h => (
              <div
                key={h.symbol}
                onClick={() => setSelectedHoldingForDetail(h)}
                className="bg-white rounded-[28px] border border-[#E2E8F0] hover:border-[#2563EB] transition-all p-6 space-y-4 shadow-sm cursor-pointer group"
              >
                <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-[#E2E8F0] pb-4 gap-2">
                  ...
                  <div className="flex items-center gap-3 text-xs font-bold">
                    <span className="bg-blue-50 text-[#2563EB] px-3 py-1 rounded-full">Decision Score: {h.decisionScore}/100</span>
