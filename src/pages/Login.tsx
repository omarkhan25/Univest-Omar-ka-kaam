          ...
          {isLoggingIn ? (
            <div className="flex flex-col items-center justify-center flex-1 h-full py-16 text-center">
              <motion.div
                ...
                className="w-16 h-16 border-4 border-purple-700 border-t-transparent rounded-full mb-8 mx-auto"
              />
              <motion.h2
            ...
            <div className="flex flex-col flex-1 h-full justify-center">
              ...
              >
                <div className="w-16 h-16 mx-auto bg-emerald-100 text-purple-700 rounded-full flex items-center justify-center mb-6">
                ...
                <button
                  ...
                  className="w-full py-3.5 bg-purple-700 hover:bg-purple-800 active:bg-purple-900 text-white font-black text-xs rounded-xl tracking-wider uppercase transition shadow-md shadow-purple-700/10 cursor-pointer"
                >
                  Create Account
                </button>
              </motion.div>
            ...
            <div>
              ...
              <div className="mb-8 text-left">
                ...
                {!otpSent ? (
                  <>
                    ...
                    <p className="text-slate-400 text-[15px] font-medium mt-2">Sign in to continue to your investment workspace.</p>
                  </>
                ) : (
              ...
              {!otpSent && (
                <div className="grid grid-cols-3 gap-4 mb-8">
                  ...
                  <button
                    type="button"
                    className="flex items-center justify-center py-3.5 bg-white border border-slate-200/80 hover:border-slate-300 hover:bg-slate-50 hover:shadow-sm hover:-translate-y-0.5 rounded-xl transition-all cursor-pointer group"
                  >
                    <svg className="w-5 h-5 text-slate-700 group-hover:text-black transition-colors" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <button
                    type="button"
                    className="flex items-center justify-center py-3.5 bg-white border border-slate-200/80 hover:border-slate-300 hover:bg-slate-50 hover:shadow-sm hover:-translate-y-0.5 rounded-xl transition-all cursor-pointer grayscale hover:grayscale-0"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center justify-center py-3.5 bg-white border border-slate-200/80 hover:border-slate-300 hover:bg-slate-50 hover:shadow-sm hover:-translate-y-0.5 rounded-xl transition-all cursor-pointer group"
                  >
                    <svg className="w-4 h-4 text-slate-700 group-hover:text-black transition-colors" viewBox="0 0 24 24" fill="currentColor">
                ...
                <form onSubmit={handleSendOtp} className="space-y-5">
                  ...
                  <div className={`relative rounded-[16px] px-5 py-3 transition-all duration-300 text-left bg-slate-50 ${errorMessage ? 'border border-rose-500/50 bg-rose-50' : 'border border-slate-200/60 focus-within:bg-white focus-within:border-purple-500 focus-within:ring-4 focus-within:ring-purple-500/10 focus-within:shadow-sm'
                    ...
                    <input
                      ...
                      className="w-full bg-transparent border-none outline-none text-slate-900 placeholder-slate-400 text-[15px] font-medium py-1 focus:ring-0 focus:outline-none"
                      required
                    />
                  </div>

                  {/* Keep me logged in & Forgot password */}
                  <div className="flex items-center justify-between text-[13px] font-bold text-slate-400 mt-3">
                    <label className="flex items-center gap-2 cursor-pointer select-none">
                      <input
                        type="checkbox"
                        className="w-3.5 h-3.5 rounded border-slate-300 text-purple-700 focus:ring-purple-700"
                      />
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between text-[13px] font-bold text-slate-400">
                    ...
                    <button
                      ...
                      className="text-purple-700 hover:underline disabled:text-slate-300 disabled:no-underline"
                    >
              ...
              <div className="mt-8 text-center text-[14px]">
                ...
                <button
                  type="button"
                  onClick={() => navigate('/signup')}
                  className="text-purple-700 font-black hover:underline transition-colors"
                >
                  Create Account
                </button>
              </div>
